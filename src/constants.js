...
export const GUIDED_TOURS = [
  {
    ...
    stops: [
      ...
      { name: 'Station VIII', query: 'Via Dolorosa', description: 'Jesus meets and consoles the women of Jerusalem', landmark: 'Greek Orthodox Monastery with Latin cross on wall', coords: { lat: 31.77791, lng: 35.23020 } },
